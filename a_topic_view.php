...
<html lang="en">
<head>
  <title><?php echo $myfname . " " . $mylname ?></title>
  <meta charset="utf-8">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a id="lnks" href="category_control">List Of Topic</a></li> 
      </ul>  
    </div>
  </div>
</nav>
...
<div class="container-fluid">  
     ...
     <div class="toptext"><?php echo $mytopic . " " . "  (ID: $mysid) "; ?></div>     
     ...
     <div class="row">
     <div class="col-sm-4 col-md-4 col-lg-4"></div>
     <div id="coltitle" class="col-sm-4 col-md-4 col-lg-4">DATES: <? echo $mday ." ". $mydate . " ". $mymonth ." ".$mmyer ?></div>
     <div class="col-sm-4 col-md-4 col-lg-4"></div>  
     ...
     <div class="panel-heading" id="coltitle"><strong><?php echo $myfname . " " . $mylname; ?><?php echo " (ID: $mysid)"; ?></strong></div>
