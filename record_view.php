...
<div class="container">   
    ...
    <h3>The Following Information Entered into Database:</h3><br> 
     
     <div class="row">      
     <div id="coltitle" class="col-xs-1">Person ID:</div>
     <div id="output" class="col-xs-11"><?php echo $pid; ?></div>
     </div>
     
    
     <div class="row">
     <div id="coltitle" class="col-xs-1">Subject</div>
     <div id="output" class="col-xs-11"><?php echo $topic; ?></h4></div>    
     </div>
     
     <div class="row">
     <div id="coltitle" class="col-xs-1">Category</div>
     <div id="output" class="col-xs-11"><?php echo $category; ?></h4></div>    
     </div>
    
     <div class="row">
     <div id="output" class="col-xs-12">
     <textarea cols="65" rows="12" readonly><?php echo $comments; ?></textarea>    
     </div>
     </div>
